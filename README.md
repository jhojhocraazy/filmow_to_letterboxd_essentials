...
Se o sistema retornar erro de comando não reconhecido (comum no Windows), force a instalação utilizando o Python Launcher nativo:
...
`py filmow_to_letterboxd_essentials.py seunomedeusuario --modo letterboxd --delay 2.5`